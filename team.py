                ...
                if name in existing_names:
                    ...
                    while name in existing_names or not name:
                        ...
                        if not name:
                            return
                        name = name.strip()
                # Capitalize each word, rest lowercase
                def smart_title(s):
    ...
    def show_final_teams_only(self):
        ...
        def show_players(team, btn_widget):
            ...
            for widget in pf.winfo_children():
                widget.destroy()
            # Show all players for the selected team
            ...
            if not members:
                ...
                for i, member in enumerate(members, 1):
                    tk.Label(pf, text=f"  {i}. {member}", font=("Arial", 14), fg="#154360", bg="#FDFEFE", anchor="w", justify="left").pack(fill="x", padx=24, pady=4)
